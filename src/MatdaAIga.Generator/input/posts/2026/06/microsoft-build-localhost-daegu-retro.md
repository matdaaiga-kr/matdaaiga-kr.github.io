Title: Microsoft Build //localhost:Daegu 후기
Lead: 글로벌 개발자 컨퍼런스의 핵심 흐름을 정리해봐요
...
이번 행사는 샌프란시스코에서 열린 Microsoft Build 2026의 주요 발표를 지역 개발자 커뮤니티와 함께 다시 읽고, 실제 개발 현장에서 바로 적용할 수 있는 관점으로 연결해보는 자리였습니다. AI 에이전트, Azure 클라우드, GitHub Copilot까지 개발자의 워크플로우를 바꾸고 있는 흐름을 한 번에 정리할 수 있었습니다.

![행사 전체 사진][image-00]

"이번 Build에서 무엇이 달라졌는지"를 단순 요약으로 끝내지 않고, "현장에서 어떤 방식으로 적용할 수 있는지"까지 연결해보는 소중한 시간이었습니다. 

### Session1. 엔터프라이즈가 사랑하는 GitHub Copilot SDK, 그 확장 가능성 | 이보라

![session1][image-01]

Microsoft MVP이자 모던웹연구소 대표인 이보라님은 GitHub Copilot SDK의 확장 가능성과 실제 적용 사례를 중심으로 세션을 진행했습니다. Copilot SDK를 활용하면 단순 코드 자동 완성을 넘어, 팀 단위의 협업 생산성을 높이는 다양한 워크플로우를 설계할 수 있다는 점이 인상적이었습니다.

- [이보라님이 알려주는 다양한 개발 소식 링크드인에서 받아보기][bora-sns]

### Session2. 내 시스템에 꼭 맞는 AI 모델 선택하기 | 김근희
...
### Session4. GitHub Copilot 야~호! 바닥부터 시작하는 딸깍 앱 개발 배포 실습 | 유저스틴
